...
namespace BLL
{
    public class MetaBLL
    {
        ...
        public bool AddMeta(MetaDTO model)
        {
            ...
            LogDAO.AddLog(General.ProcessType.MetaAdd, General.TablesName.Meta, model.MetaID);
            return true;
        ...
        public bool UpdateMeta(MetaDTO model)
        {
            ...
            LogDAO.AddLog(General.ProcessType.MetaUpdated,General.TablesName.Meta,model.MetaID);
            return true;
        }
    }
}
